...
public class PollingAdapter extends BaseAdapter {
   ...
   /* public PollingAdapter(Context _context, List<Student> _student) {
        this.context = _context;
        layoutInflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        this.list = _student;
    }*/

    public PollingAdapter(Context applicationContext, List<Student> pollingList, List<String> checkedList) {
        this.context = applicationContext;
        layoutInflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        this.list = pollingList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View satirView = layoutInflater.inflate(R.layout.ogrenci_poll_item, null);
        ...
        if(checkedList.contains(student.getStudent_no()))
           icon.setImageResource(R.drawable.checked);    // eğer derse gelen listesinde varsa tik atıyoruz.
        else
